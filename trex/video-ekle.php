			...
			<div class="card">
				<div class="card-heading card-default">
					<div class="pull-right mt-10">
						<a href="video-galerisi.php?album=<?php echo $_GET['album']; ?>" class="btn btn-warning btn-icon"><i class="fa fa-reply"></i>Geri Dön</a>
					</div>
					Video Ekle
				</div>
				<div class="card-block">
					<form method="POST" enctype="multipart/form-data" action="controller/function.php" class="form-horizontal">	
						<input type="hidden" name="album" value="<?php echo $_GET['album']; ?>" class="form-control">					
