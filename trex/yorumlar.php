							...
							while ($yorumcek=$yorumsor->fetch(PDO::FETCH_ASSOC)) {
								...
								<tr>
									...
									<td class="text-center">
										<a href="yorum-resim-duzenle.php?yorum_id=<?php echo $yorumcek['yorum_id']; ?>" class="btn btn-primary btn-icon"><i class="icon-picture"></i> Resim Ayarları</a>
									</td>
									<td class="text-center">
