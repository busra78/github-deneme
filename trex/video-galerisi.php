...
$vidsor->execute(array('Album' => $_GET['album']));
?>		
<!-- ============================================================== -->
<!-- 						Content Start	 						-->
<!-- ============================================================== -->
			...
			<div class="card">
				<div class="card-heading card-default">
					<div class="pull-right mt-10">
						<a href="video-ekle.php?album=<?php echo $_GET['album']; ?>" class="btn btn-success btn-icon"><i class="fa fa-download"></i>Video Yükle</a>
					</div>
							...
							<div class="modal fade bs-example-modal-lg" id="textModal<?php echo $vidprint['video_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="textModal">
								<div class="modal-dialog modal-lg" role="document">
									<div class="modal-content">
										...
										<a href="controller/function.php?videosil=ok&video_id=<?php echo $vidprint['video_id']; ?>&video_album=<?php echo $_GET['album']; ?>" class="btn btn-danger btn-icon"><i class="fa fa-trash-o"></i> Video Sil</a>
									</div>
								</div>
							</div>
						<?php } ?>
