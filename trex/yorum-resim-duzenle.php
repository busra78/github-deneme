...
include 'topbar.php';
include 'sidebar.php';
$urunedit=$db->prepare("SELECT * from yorumlar where yorum_id=:yorum_id");
		...
		<div class="col-sm-12">
			<div class="card">
				...
				<div class="card-block">
					...
					<form action="controller/resimy.php" class="dropzone" >
						<input type="hidden" name="resim_urun" value="<?php echo $urunwrite['yorum_id']; ?>">
					</form>
					...
					<form method="POST" action="controller/function.php" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="card-block">
							<div class="lightboxGallery">
								<?php 
								$resimsor=$db->prepare("SELECT * from resimy where resim_urun=:resim_id");
								$resimsor->execute(array(
									'resim_id' => $urunwrite['yorum_id']
								));
												...
												<div class="modal-content">
													<div class="modal-body">
														...
														<div class="text-center">
															<a href="controller/function.php?yorumresimsil=ok&resim_id=<?php echo $resimcek['resim_id']; ?>&eski_yol=<?php echo $resimcek['resim_link']; ?>&yorum_id=<?php echo $urunwrite['yorum_id']; ?>"><i class="fa fa-trash-o"></i> Resmi Sil</a>
														</div>
													</div>
												</div>
											</div>
