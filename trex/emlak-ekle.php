...
<section class="main-content container">
    <div class="page-header">
        <h2>Satılık Villa&Köşk&Konak&Yalı İşlemleri</h2>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="tabs">
                        ...
                        <div class="widget white-bg">
                            ...
                            <div class="card-heading card-default">
                                <div class="pull-right mt-10">
                                    <a href="emlaklar.php" class="btn btn-warning btn-icon"><i class="fa fa-reply"></i>Geri Dön</a>
                                </div>
                                Satılık Villa&Köşk&Konak&Yalı Düzenle
                            </div>
                            <div class="card-block">
                                <form method="POST" action="controller/function.php" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-group">

                                        <input type="hidden" name="urun_kisaaciklama" value="7">
                                    </div>

                                    <div class="form-group">
                                        <select name="urun_kategori" class="form-control m-b" style="display: none">
                                            <option type="hidden" value="7"></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="urun_title3" class="form-control m-b">

                                            <option value="">Seçiniz</option>

                                            <?php

                                            $katsor=$db->prepare("SELECT * from kategorilerp");
                                    ...
                                    <div class="form-group">
                                        <label>Adres Detay Giriniz. </label>
                                        <input type="text" name="urun_efiyat"  placeholder="Adres giriniz"  class="form-control">
                                    </div>
