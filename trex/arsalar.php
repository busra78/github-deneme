...
include 'header.php';
include 'topbar.php';
include 'sidebar.php'; // Buraya hangi kategorinin ürünleri gelmesini istiyorsan onun idsini yazman gerekiyor
            ...
            <div class="card">
                <div class="card-heading card-default">
                    <div class="pull-right mt-10">
                        <a href="arsa-ekle.php" class="btn btn-primary btn-icon"><i class="fa fa-plus"></i>Satılık Arsa Ekle</a>
                    </div>
                    SATILIK ARSA
                </div>
                        ...
                        while ($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="arsa-resim-duzenle.php?urun_id=<?php echo $uruncek['urun_id']; ?>" class="btn btn-primary btn-icon"><i class="icon-picture"></i> Resim Ekle/Çıkar</a>
                                </td>
                                <td class="text-center">
                                    <a href="arsa-duzenle.php?oda_id=<?php echo $uruncek['urun_id']; ?>" title="Düzenle" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
