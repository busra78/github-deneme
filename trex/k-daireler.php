            ...
            <div class="card">
                <div class="card-heading card-default">
                    <div class="pull-right mt-10">
                        <a href="k-daire-ekle.php" class="btn btn-primary btn-icon"><i class="fa fa-plus"></i>Kiralık Daire Ekle</a>
                    </div>
                    KİRALIK DAİRELER
                </div>
                        ...
                        while ($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="k-daire-resim-duzenle.php?urun_id=<?php echo $uruncek['urun_id']; ?>" class="btn btn-primary btn-icon"><i class="icon-picture"></i> Resim Ekle/Çıkar</a>
                                </td>
                                <td class="text-center">
                                    <a href="k-daire-duzenle.php?oda_id=<?php echo $uruncek['urun_id']; ?>" title="Düzenle" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
