				...
				<div class="card-block">
					...
					<form method="POST" action="controller/function.php" enctype="multipart/form-data" class="form-horizontal">						
						<div class="form-group">
							...
							<input type="text" name="proje_baslik" placeholder="Kadro adı giriniz." class="form-control">
						</div>
						<div class="form-group">
							<label>Ünvan</label>
							<input type="text" name="proje_kategori" placeholder="Kadro ünvan giriniz." class="form-control">
						</div>
						<div class="form-group">
