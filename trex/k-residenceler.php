            ...
            <div class="card">
                <div class="card-heading card-default">
                    <div class="pull-right mt-10">
                        <a href="k-residence-ekle.php" class="btn btn-primary btn-icon"><i class="fa fa-plus"></i>Kiralık Residence Ekle</a>
                    </div>
                    KİRALIK RESIDENCE
                </div>
                        ...
                        while ($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="k-residence-resim-duzenle.php?urun_id=<?php echo $uruncek['urun_id']; ?>" class="btn btn-primary btn-icon"><i class="icon-picture"></i> Resim Ekle/Çıkar</a>
                                </td>
                                <td class="text-center">
                                    <a href="k-residence-duzenle.php?oda_id=<?php echo $uruncek['urun_id']; ?>" title="Düzenle" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
