...
$dil1=$db->prepare("SELECT * from dil where dil_id=1");
$dil1->execute(array());
$dil1print=$dil1->fetch(PDO::FETCH_ASSOC);
$dil2=$db->prepare("SELECT * from dil where dil_id=2");
$dil2->execute(array());
$dil2print=$dil2->fetch(PDO::FETCH_ASSOC);
$dil3=$db->prepare("SELECT * from dil where dil_id=3");
$dil3->execute(array());
$dil3print=$dil3->fetch(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="tr">
<head>
  ...
  <title>Scout Teknoloji - Scout Teknoloji Yönetim Sistemi</title>
