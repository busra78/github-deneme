												...
												<div class="modal-content">
													<div class="modal-body">
														...
														<div class="text-center">
															<a href="controller/function.php?projeresimsil=ok&resim_id=<?php echo $resimcek['resim_id']; ?>&eski_yol=<?php echo $resimcek['resim_link']; ?>&proje_id=<?php echo $urunwrite['proje_id']; ?>"><i class="fa fa-trash-o"></i> Resmi Sil</a>
														</div>
													</div>
												</div>
											</div>
