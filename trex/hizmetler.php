							...
							while ($hizmetcek=$hizmetsor->fetch(PDO::FETCH_ASSOC)) {
								...
								<tr>
									...
									<td class="text-center">
										<a href="hizmet-sss.php?hizmet_id=<?php echo $hizmetcek['hizmet_id']; ?>" class="btn btn-warning btn-icon"><i class="icon-picture"></i>Hizmet SSS Ayarları</a>
									</td>
									<td class="text-center">
