...
include 'topbar.php';
include 'sidebar.php';
$urunedit=$db->prepare("SELECT * from hizmetler where hizmet_id=:urun_id");
$urunedit->execute(array(
	'urun_id' => $_GET['hizmet_id']
));
		...
		<div class="col-sm-12">
			<div class="card">
				...
				<div class="card-block">
					...
					<form action="controller/resimh.php" class="dropzone" >
						<input type="hidden" name="resim_urun" value="<?php echo $urunwrite['hizmet_id']; ?>">
					</form>
					...
					<form method="POST" action="controller/function.php" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="card-block">
							<div class="lightboxGallery">
								<?php 
								$resimsor=$db->prepare("SELECT * from resimh where resim_urun=:resim_id");
								$resimsor->execute(array(
									'resim_id' => $urunwrite['hizmet_id']
								));
												...
												<div class="modal-content">
													<div class="modal-body">
														...
														<div class="text-center">
															<a href="controller/function.php?hizmetresimsil=ok&resim_id=<?php echo $resimcek['resim_id']; ?>&eski_yol=<?php echo $resimcek['resim_link']; ?>&hizmet_id=<?php echo $urunwrite['hizmet_id']; ?>"><i class="fa fa-trash-o"></i> Resmi Sil</a>
														</div>
													</div>
												</div>
											</div>
