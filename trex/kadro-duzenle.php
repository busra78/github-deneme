			...
			<div class="card">
				<div class="card-heading card-default">
					<div class="pull-right mt-10">
						<a href="kadro.php" class="btn btn-warning btn-icon"><i class="fa fa-reply"></i>Geri Dön</a>
					</div>
					Kadro Düzenle
				</div>
				<div class="card-block">
					<div class="form-group">
						...
						<input type="text" value="<?=seo('kadro-'.$projewrite["proje_baslik"]).'-'.$projewrite["proje_id"]?>" readonly class="form-control">
					</div>
					<form method="POST" action="controller/function.php" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="form-group">
							<label>Kadro Adı</label>
							<input type="text" name="proje_baslik" value="<?php echo $projewrite['proje_baslik']; ?>" class="form-control">
						</div>
						<div class="form-group">
							<label>Ünvan</label>
							<input type="text" name="proje_kategori" value="<?php echo $projewrite['proje_kategori']; ?>" class="form-control">
						</div>
						<div class="form-group">
							<label>Kadro Detay Açıklama</label>
